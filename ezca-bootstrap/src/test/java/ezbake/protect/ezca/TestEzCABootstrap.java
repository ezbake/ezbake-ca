...
public class TestEzCABootstrap {
    ...
    public void setUpFileSystem() throws IOException {
        ...
        FileUtils.writeStringToFile(new File(FilePersist.joinPath(root, "ezsecurity_reg", "ezbakeca", "x509_cert", "", "data")), "ezbake ca certificate");
        ...
        FileUtils.writeStringToFile(new File(FilePersist.joinPath(root, "ezsecurity_reg", "_Ez_Security", "x509_cert", "", "data")), "my cert");
        ...
        FileUtils.writeStringToFile(new File(FilePersist.joinPath(root, "ezsecurity_reg", "100", "x509_cert", "", "data")), "my cert");
